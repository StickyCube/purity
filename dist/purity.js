(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.purity = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
},{"_process":65}],49:[function(require,module,exports){
'use strict';
...
module.exports = require('./src/squish');

},{"./src/squish":56}],56:[function(require,module,exports){
'use strict';
...
},{"./src/main":62}],58:[function(require,module,exports){
'use strict';
...
},{"./get":61,"./utils":64}],59:[function(require,module,exports){
'use strict';
...
},{"./check":58,"./configuration":59,"./ensure":60,"./get":61,"./set":63}],63:[function(require,module,exports){
'use strict';
...
},{"./configuration":59}],65:[function(require,module,exports){
...
var _class = function () {
  ...
  _createClass(_class, [{
    ...
    value: function error(type) {
      ...
      return _utils.Promise.reject(err);
    }
  }]);
...
},{"./utils":72,"./validation-error":73}],67:[function(require,module,exports){
'use strict';
...
var _dataValidator = require('./data-validator');
...
function defineType(options) {
  var Type = function (_DataValidator) {
    _inherits(Type, _DataValidator);

    function Type() {
      _classCallCheck(this, Type);

      var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Type).apply(this, arguments));

      _this.constraints = _this.setupConstraints(options.constraints);
      _this.transforms = _this.setupTransforms();
      return _this;
    }
    ...
    _createClass(Type, [{
      ...
      value: function check(v) {
        return (options.check || _get(Object.getPrototypeOf(Type.prototype), 'check', this))(v);
      }
    }, {
      key: 'cast',
      value: function cast(v) {
        return (options.cast || _get(Object.getPrototypeOf(Type.prototype), 'cast', this))(v);
      }
    }]);

    return Type;
  }(_dataValidator2.default);

  var aliases = (0, _utils.ensureArray)(options.aliases);
...
function createTypeValidator(definition, options) {
...
},{"./data-validator":68,"./utils":72}],68:[function(require,module,exports){
'use strict';
...
var DataValidator = function (_AbstractValidator) {
  _inherits(DataValidator, _AbstractValidator);

  function DataValidator(definition, options) {
    _classCallCheck(this, DataValidator);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DataValidator).call(this, options));

    _this.definition = definition;
    return _this;
  }

  _createClass(DataValidator, [{
    key: 'check',
    ...
    key: 'setupConstraints',
    value: function setupConstraints(constraints) {
      var _this2 = this;

      return Object.keys(constraints || {}).filter(function (key) {
        return key in _this2.definition;
      }).reduce(function (arr, key) {
        var opts = _this2.definition[key];
        var fn = constraints[key];
        return [{ opts: opts, fn: fn }].concat(_toConsumableArray(arr));
      }, []);
    }
  }, {
    key: 'setupTransforms',
    value: function setupTransforms() {
      return (0, _utils.ensureArray)(this.definition.$transform).filter(_utils.isFunction);
    }
  }, {
    key: 'validate',
    value: function validate(data, opt) {
      var options = (0, _utils.clone)(opt);

      options.path = this.options.path;

      return (0, _utils.isMissing)(data) ? this.validateMissing(data, options) : this.validateData(data, options);
    }
  }, {
    key: 'getDefaultValue',
    value: function getDefaultValue() {
      var defaultValue = this.definition.$default;
      return typeof defaultValue === 'function' ? defaultValue() : defaultValue;
    }
  }, {
    key: 'validateMissing',
    value: function validateMissing(data, options) {
      var isRequired = !!this.definition.$required;
      var hasDefault = '$default' in this.definition;
      var result = null;
      ...
      options.value = hasDefault ? this.getDefaultValue() : data;

      options.required = isRequired;

      result = new _validationResult2.default(options);

      return _utils.Promise.resolve(result);
    }
  }, {
    key: 'validateData',
    value: function validateData(data, options) {
      ...
      return this.applyconstraints(data).then(function () {
        options.value = _this3.transform(data);
        return new _validationResult2.default(options);
      });
    }
  }, {
    key: 'applyconstraints',
    value: function applyconstraints(data) {
      var constraints = this.constraints;

      for (var i = 0; i < constraints.length; i += 1) {
        var assertion = constraints[i];
        var assert = assertion.fn;
        var opts = assertion.opts;
    ...
    value: function transform(data) {
      return this.transforms.reduce(function (data, next) {
        return next(data);
      }, data);
    }
  }]);
...
}(_abstractValidator2.default);

module.exports = DataValidator;

},{"./abstract-validator":66,"./utils":72,"./validation-result":74}],69:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ValidationError = exports.Types = undefined;
...
exports.Types = _dataTypes.Types;
function Schema() {
  return new (Function.prototype.bind.apply(_schema2.default, [null].concat(Array.prototype.slice.call(arguments))))();
}

function createDataType(opts) {
  opts.aliases = (0, _utils.ensureArray)(opts.aliases);

  if (!opts.aliases.length) {
    throw new Error('options.aliases requires at least one alias');
  }

  (0, _dataTypes.defineType)(opts);
}
...
createDataType({
  ...
  aliases: [_dataTypes.Types.String, String],
  constraints: {
    $minlength: function $minlength(act, opt) {
      return act.length >= opt;
    },
    $maxlength: function $maxlength(act, opt) {
      return act.length <= opt;
    },
    $fixedwidth: function $fixedwidth(act, opt) {
      return act.length === opt;
    },
    $regex: function $regex(act, opt) {
      return opt.test(act);
    }
  }
});
...
createDataType({
  check: function check(v) {
    return !(0, _utils.isNan)(v);
  },
  cast: function cast(v) {
    return parseFloat(v);
  },
  aliases: [_dataTypes.Types.Number, Number],
  constraints: {
    $gt: function $gt(act, opt) {
      return act > opt;
    },
    $gte: function $gte(act, opt) {
      return act >= opt;
    },
    $lt: function $lt(act, opt) {
      return act < opt;
    },
    $lte: function $lte(act, opt) {
      return act <= opt;
    },
    $eq: function $eq(act, opt) {
      return act === opt;
    },
    $neq: function $neq(act, opt) {
      return act !== opt;
    }
  }
});
...
createDataType({
  ...
  aliases: [_dataTypes.Types.Boolean, Boolean],
  constraints: {
    $eq: function $eq(act, opt) {
      return act === opt;
    },
...
createDataType({
  ...
  aliases: [_dataTypes.Types.Date, Date],
  constraints: {
    $gt: function $gt(act, opt) {
      return act > opt;
    },
...
},{"./data-types":67,"./schema":71,"./utils":72,"./validation-error":73}],70:[function(require,module,exports){
'use strict';
...
var _objectSquish = require('object-squish');

var _objectSquish2 = _interopRequireDefault(_objectSquish);

var _okJs = require('ok-js');

var _okJs2 = _interopRequireDefault(_okJs);
...
var SchemaValidator = function (_AbstractValidator) {
  _inherits(SchemaValidator, _AbstractValidator);

  function SchemaValidator(definition, options) {
    _classCallCheck(this, SchemaValidator);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SchemaValidator).call(this, options));

    _this.definition = null;
    _this.validators = null;

    _this.definition = _this.getDefinition(definition);
  ...
  _createClass(SchemaValidator, [{
    ...
    value: function getDefinition(definition) {
      ...
      if (!(0, _utils.isPlainObject)(definition)) {
        definition = { $type: definition };
      }
    ...
    key: 'createPromises',
    value: function createPromises(data) {
      var _this2 = this;

      var paths = Object.keys(this.validators);

      return data.reduce(function (promises, data, idx) {
        return paths.map(function (path) {
          var index = _this2.options.isArray ? idx : null;
          var validator = _this2.validators[path];
          var value = _okJs2.default.get(data, path || null);
          var options = { index: index, cast: _this2.options.cast };
    ...
    value: function compile() {
      var flattened = (0, _utils.isEndpoint)(this.definition) ? { '': this.definition } : (0, _objectSquish2.default)(this.definition, { stopWhen: _utils.isEndpoint });
      var paths = Object.keys(flattened);

      this.validators = paths.reduce(function (validators, path) {
        var value = flattened[path];

        if ((0, _utils.isSchema)(value) || (0, _utils.isArray)(value)) {
          validators[path] = new SchemaValidator(value, { path: path });
        } else {
          validators[path] = (0, _dataTypes.createTypeValidator)(value, { path: path });
        }
    ...
    value: function validate(data, opt) {
      ...
      var array = (0, _utils.isArray)(data);
      var options = (0, _utils.clone)(opt);
      ...
      var promises = this.createPromises(data);

      return _utils.Promise.all(promises).then(function (results) {
        options.value = _this3.inflate(results);
        options.path = _this3.options.path;
        return new _validationResult2.default(options);
      });
    }
  }, {
    key: 'inflate',
    value: function inflate(results) {
      return this.options.isArray ? _validationResult2.default.inflateArray(results) : _validationResult2.default.inflateObject(results);
    }
  }]);
...
},{"./abstract-validator":66,"./data-types":67,"./utils":72,"./validation-result":74,"object-squish":55,"ok-js":57}],71:[function(require,module,exports){
'use strict';
...
var _class = function () {
  function _class(definition, options) {
    _classCallCheck(this, _class);

    this._validator = new _schemaValidator2.default(definition, options);
    this._isPuritySchema_ = true;
  }

  _createClass(_class, [{
    key: '_validateUsingCallback',
    value: function _validateUsingCallback(data, done) {
      this._validator.validate(data).catch(done).then(function (r) {
        return done(null, r.value);
      });
    }
  }, {
    key: '_validateUsingPromise',
    value: function _validateUsingPromise(data, opt) {
      var _this = this;

      return new _utils.Promise(function (resolve, reject) {
        _this._validateUsingCallback(data, function (e, r) {
    ...
    value: function validate() {
      return arguments.length === 2 ? this._validateUsingCallback.apply(this, arguments) : this._validateUsingPromise.apply(this, arguments);
    }
  }]);
...
},{"./schema-validator":70,"./utils":72}],72:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.clone = exports.ensureArray = exports.isMissing = exports.identity = exports.isEndpoint = exports.isNan = exports.isPlainObject = exports.isFunction = exports.isArray = exports.isSchema = exports.isValue = exports.Map = exports.Promise = undefined;
...
var isValue = exports.isValue = function isValue(v) {
  return v != null;
};
var isSchema = exports.isSchema = function isSchema(v) {
  return isValue(v) && v._isPuritySchema_;
};
...
var isPlainObject = exports.isPlainObject = function isPlainObject(v) {
  return isValue(v) && v.constructor === Object;
};
var isNan = exports.isNan = function isNan(v) {
  return v !== v || typeof v !== 'number';
};
var isEndpoint = exports.isEndpoint = function isEndpoint(v) {
  return isPlainObject(v) && '$type' in v;
};
var identity = exports.identity = function identity(v) {
  return v;
};
var isMissing = exports.isMissing = function isMissing(v) {
  return !isValue(v) || v === '';
};

var ensureArray = exports.ensureArray = function ensureArray(v) {
  if (!isValue(v)) return [];
...
},{"es6-map":42,"es6-promise":48}],73:[function(require,module,exports){
'use strict';
...
var ValidationResult = function () {
  ...
  _createClass(ValidationResult, [{
    ...
    key: 'index',
    get: function get() {
      return typeof this.options.index === 'number' ? this.options.index : null;
    }
  }, {
    key: 'value',
    get: function get() {
    ...
    key: 'inflateArray',
    value: function inflateArray(results) {
      var data = [];
    ...
    key: 'inflateObject',
    value: function inflateObject(results) {
      ...
      for (var i = 0; i < results.length; i += 1) {
        ...
        if (!result.required && typeof value === 'undefined') {
          _okJs2.default.ensure(data, path.replace(/\.[^.]+$/, ''), {});
        } else {
          _okJs2.default.set(data, path, value);
        }
      }
